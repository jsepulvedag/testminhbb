<%@ Control Language="C#" AutoEventWireup="true" Codebehind="Register.ascx.cs" Inherits="Restaurant.Presentation.Home.Member.Registration.Register" %>
...
<div id="formConntent" style="margin:0 auto;">
    ...
    <div class="formContentCenter">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td colspan="5" align="left" style="height:27px;padding-left:5px;">
                    <h4>
            ...
            <tr>
                <td style="width: 104px; text-align: left; height: 27px;padding-left:50px;">
                    User name:
                </td>
            ...
            <tr>
              ...
              *
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtPassword"
                        ErrorMessage="6-20 characters including at least 1 upper or lower alpha, and 1 digit"
                        ValidationExpression="^(?=.*\d)(?=.*[a-zA-Z])(?!.*[\W_\x7B-\xFF]).{6,15}$"></asp:RegularExpressionValidator></td>
            </tr>
            <tr>
                <td style="width: 104px; text-align: left; height: 27px;padding-left:50px;">
                    Comfirm password:</td>
            ...
            *
            ...
            <tr>
                <td style="width: 104px; height: 27px; text-align: left;padding-left:50px;">
                    Title:</td>
            ...
            *
            ...
            <tr>
                ...
                <td colspan="4" style="height: 26px; width: 621px;" align="left">
                    &nbsp;
                    <asp:TextBox ID="txtLastName" runat="server" Width="220px" />
            ...
            *
            ...
            <tr>
                <td style="text-align: left; height: 27px; width: 104px;padding-left:50px;">
                    Birthday:
                </td>
            ...
            *
            ...
            <tr>
                ...
                <td colspan="4" style="height: 27px;" align="left">
                    &nbsp;
                    <asp:TextBox ID="txtAddress" runat="server" Width="362px" /></td>
            </tr>
            <tr>
                <td style="text-align: left; width: 104px; height: 27px;padding-left:50px;">
                    Phone number:
                </td>
            ...
            <tr>
                <td style="text-align: left; width: 104px; height: 27px;">
                </td>
                <td align="left" colspan="4" style="height: 27px; width: 621px;">
                    &nbsp;
            ...
            <tr>
                <td style="width: 104px; height: 27px; text-align: left">
                </td>
                <td align="left" colspan="4" style="width: 621px; height: 27px">
                <div id="Div1">
                        <div > <%--class="formContentCenter"--%>
...
2. Your use of Google’s products, software, services and web sites (referred to collectively as the “Services” in this document and excluding any services provided to you by Google under a separate written agreement) is subject to the terms of a legal agreement between you and Google. “Google” means Google Inc., whose principal place of business is at 1600 Amphitheatre Parkway, Mountain View, CA 94043, United States. This document explains how the agreement is made up, and sets out some of the terms of that agreement.
            ...
            <tr>
                ...
                <td align="left" colspan="4" style="height: 27px; width: 621px;">
                    &nbsp;
                    <asp:Button ID="btnRegister"   runat="server" OnClick="btnRegister_Click" Text="Register" Width="85px" CssClass="Button" />
                    <asp:Button ID="btnCancel" runat="server" OnClick="btnCancel_Click" Text="Cancel" Width="85px" CssClass="Button" />
                </td>
            </tr>
        </table>
    </div>
