<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DefineGiftCommision.ascx.cs" Inherits="Restaurant.Presentation.Administrator.GiftCertificates.DefineGiftCommision" %>

<center>
<br />
<table style="width:800px;height:auto;color:black">
    <caption style="text-align:center;font-size:large;font-weight:bold;">Define Gift Commission</caption>
    <tr>
        <td colspan="2"><br />
            <asp:GridView ID="gvCommission" Width="100%" runat="server" AllowPaging="True" AutoGenerateColumns="False" PageSize="6" CellPadding="4" CellSpacing="2">
                <Columns>
            ...
            <table style="width: 90%;margin:0 auto; float:left;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Label ID="lblMess" runat="server" ForeColor="Red" Visible="False"></asp:Label></td>
                </tr>
                <tr>
                    <td style="text-align:left;width:11%;">
                        Type&nbsp;</td>
