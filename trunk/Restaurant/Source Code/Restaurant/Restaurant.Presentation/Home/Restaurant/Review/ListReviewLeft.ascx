<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListReviewLeft.ascx.cs" Inherits="Restaurant.Presentation.Home.Restaurant.Review.ListReviewLeft" %>
<table>
<tr>
<td>
                ...
                <table style="width: 100%">
                    <tr>
                        <td align="center" colspan="2" valign="top">                            
                            <asp:Image ID="Image1" runat="server" ImageUrl="~/Media/Images/leftAds1.jpg" Width="100%" /></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center">
                        <div>
                            <asp:HyperLink ID="hplViewPhoto" runat="server" NavigateUrl="~/Home/Member/Photo/PhotoDetail.ascx">View Photo</asp:HyperLink> >>
                        </div>
                            <div>
                    ...
                    <tr>
                        <td align="left" colspan="2" style="width:100%; padding-left:30px;">
                            <asp:Label ID="lblDateOpened" runat="server" Text='<%# Eval("DateOpened") %>' Width="100%"></asp:Label><br />
                            <br />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="left" colspan="2">
                            <asp:Image ID="Image4" runat="server" ImageUrl="~/Media/Images/leftAds2.jpg" Width="100%" />
                        </td>
                    </tr>
                </table>
