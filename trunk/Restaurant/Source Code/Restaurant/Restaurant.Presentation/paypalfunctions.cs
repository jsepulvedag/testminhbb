...
public class NVPAPICaller
{
    ...
    private string pendpointurl = "https://payflowpro.verisign.com";

    private const string VENDOR = "VENDOR";
    private const string PARTNER = "PARTNER";
    private const string PWD = "PWD";

    private string APIUser = "nhatnv823@gmail.com";
    private string APIPassword = "nhatnv823";
    private string APIVendor = "nhatnv823@gmail.com";
    private string APIPartner = "developer";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
		...
		if (Env == "pilot")
		{
			pendpointurl = "https://pilot-payflowpro.verisign.com";
			host = "www.sandbox.paypal.com";
		}

        string returnURL = "http://212cuisine.com";
        string cancelURL = "http://212cuisine.com";
    ...
    public string HttpCall(string NvpRequest,string unique_id) //CallNvpServer
    {
		...
		if (Env == "pilot")
		{
			objRequest.Headers.Add("Host","pilot-payflowpro.verisign.com");
		}
		else
		{
			objRequest.Headers.Add("Host","payflowpro.verisign.com");
		}
